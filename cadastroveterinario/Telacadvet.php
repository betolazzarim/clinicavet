...
<form action="cadastrovetbanco.php" method="post">
  ...
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" name="nomevet"  type="text" id="sample3">
  ...
  <br>
			   ...
			   <div class = "mdl-cell mdl-cell--6-col graybox">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input class="mdl-textfield__input" name="crmv" type="number"  id="sample5" >
  ...
  <br>				
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input class="mdl-textfield__input" name="celular" type="number" id="sample5" >
